...
namespace FarmGame.Data.Core
{
    ...
    public class GameSaveData
    {
        ...
        /// <summary>已离场 scene 的 world-state 快照（正式存档只缓存 off-scene）</summary>
        public List<SceneWorldSnapshotSaveData> offSceneWorldSnapshots;
        ...
        public GameSaveData()
        {
            ...
            offSceneWorldSnapshots = new List<SceneWorldSnapshotSaveData>();
        }
    }
    ...
    [Serializable]
    public class SceneWorldSnapshotSaveData
    {
        public string sceneKey;
        public bool hasCapturedTotalDays;
        public int capturedTotalDays;
        public List<WorldObjectSaveData> worldObjects = new List<WorldObjectSaveData>();
    }

    [Serializable]
    public class WorkbenchRuntimeSaveData
    {
        public string stationKey;
        public string sceneName;
        public string scenePath;
        public List<WorkbenchQueueEntrySaveData> queueEntries = new List<WorkbenchQueueEntrySaveData>();
    }

    [Serializable]
    public class WorkbenchQueueEntrySaveData
    {
        public int recipeId;
    ...
    public class ChestSaveData
    {
        ...
        /// <summary>箱子来源</summary>
        public int origin = -1;

        /// <summary>箱子归属</summary>
        public int ownership = -1;

        /// <summary>是否曾经被锁过</summary>
    ...
    public class DropDataDTO
    {
        ...
        /// <summary>掉落物携带的运行时物品实例态</summary>
        public InventorySlotSaveData runtimeItem;
    }
    ...
    public static class SaveDataHelper
    {
        ...
        public static InventoryItem FromSaveData(InventorySlotSaveData data)
        {
            ...
            item.RestoreInstanceIdForLoad(data.instanceId);
