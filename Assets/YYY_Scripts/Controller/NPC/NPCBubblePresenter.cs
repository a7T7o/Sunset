...
public class NPCBubblePresenter : MonoBehaviour
{
    ...
    private void EnsureBubbleUi()
    {
        ...
        _panelImage.sprite = GetOrCreateRuntimeBubbleSprite();
    ...
    private static Sprite GetOrCreateRuntimeBubbleSprite()
    {
        ...
        if (s_runtimeBubbleTexture == null)
        {
            s_runtimeBubbleTexture = new Texture2D(1, 1, TextureFormat.RGBA32, mipChain: false)
            {
            ...
            s_runtimeBubbleTexture.SetPixel(0, 0, Color.white);
