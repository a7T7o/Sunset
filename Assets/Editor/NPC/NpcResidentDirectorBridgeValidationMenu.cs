...
internal static class NpcResidentDirectorBridgeValidationMenu
{
    private const string MenuPath = "Tools/NPC/Spring Day1/Run Resident Director Bridge Tests";
    private const string ResultFileName = "npc-resident-director-bridge-tests.json";
    ...
    private static readonly string[] TargetTestNames =
    {
        ...
        "NpcCrowdResidentDirectorBridgeTests.DinnerConflict_CapturedCues_ShouldStayInsideResidentPriorityRoster",
        "NpcCrowdResidentDirectorBridgeTests.DirectorCueDatabase_ShouldPreferBeatSpecificCueBeforeEnterVillageFallbackAlias"
    };
