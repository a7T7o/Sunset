...
public class TreeControllerEditor : Editor
{
    ...
    private void DrawCurrentState()
    {
        ...
        if (showCurrentState)
        {
            ...
            if (GUILayout.Button("选中父物体并打开批量树工具"))
            {
                TreeController tree = (TreeController)target;
                GameObject selectionRoot = tree != null && tree.transform.parent != null
                    ? tree.transform.parent.gameObject
                    : tree != null ? tree.gameObject : null;
                ...
                Tool_004_BatchTreeState.OpenWindow();
            }
            EditorGUI.indentLevel--;
        }
