...
internal static class NavigationAvoidanceRulesValidationMenu
{
    private const string MenuPath = "Tools/Sunset/Navigation/Run Avoidance Rules Tests";
    private const string ResultFileName = "navigation-avoidance-rules-tests.json";
    ...
    {
        "NavigationAvoidanceRulesTests.NPCAutoRoamController_ShouldRejectAutonomousRoamBadPoint_WhenGapOnlyFitsBareFootprint",
        "NavigationAvoidanceRulesTests.NPCAutoRoamController_ShouldPenalizeAutonomousBadZoneCandidate_AfterStaticBlockedDestination",
        "NavigationAvoidanceRulesTests.NPCAutoRoamController_ShouldPreferOpenSpaceOverCornerPocket_WhenAutonomousRoamScoresCandidates"
    };
