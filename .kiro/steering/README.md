...
| `git-safety-baseline.md` | Git 安全基线规范 | git、分支、提交、回退、checkpoint、preflight | 进入真实任务实现前做 Git 安全检查 |
...
| 进入实现前做 Git 安全检查 | `#git-safety-baseline` |
...
│   ├── git-safety-baseline.md   # Git 安全基线规则（Phase 6.0 新建）
...
| 2026-03-11 | Phase 6.0：新建 `git-safety-baseline.md`，补 Git 安全基线索引 |
