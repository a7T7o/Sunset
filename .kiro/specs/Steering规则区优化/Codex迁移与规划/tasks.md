...
- `Codex统一协议建设最新现场基线_2026-03-12_5a01135d.md`
- 必要时补充后续协议入口文档
...
- 明确 `active-workspace-roots` 只是协议中的一个状态层，不再被误当成全部问题本身
- 协议至少进入一条只读工具链，能够直接产出本轮最新执行基线

**验证步骤是什么**:
- 协议文档能直接回答“当前该信哪一个现场”
- 协议文档能直接回答“当前为什么还不能宣称闭环”
- 只读工具链能输出根仓库现场、线程 worktree 现场、UI 激活工作区现场、用户验收现场占位、完成态级别、冲突摘要和默认建议动作
