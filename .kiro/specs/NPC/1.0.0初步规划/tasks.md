...
- [ ] 9. 收口第一版手工验收清单
  ...
  - [x] 已补聊天可靠性：长停期间只对“附近没人 / 对方暂不可聊”做有限次重试，不会对“概率没中”反复重掷；默认聊天半径已微调到 `3.8`
  - [x] 已补验证边界说明：通过 MCP 直接读 Play 中 Animator / 组件资源会产生工具噪音，后续聊天正样本优先用 GameView 手测或 Inspector 调试入口抓取
