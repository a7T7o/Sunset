# 遮挡检查｜执行层 smoke test 01

```text
【执行层 smoke test 01｜遮挡检查】
...
先执行：
1. powershell -ExecutionPolicy Bypass -File C:\Users\aTo\.codex\tools\sunset-git-safe-sync.ps1 -Action request-branch -OwnerThread "遮挡检查" -BranchName "codex/occlusion-audit-001" -CheckpointHint "smoke-occlusion-readonly" -QueueNote "smoke-test-01"
